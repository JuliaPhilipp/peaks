...
for i in *.bed; do awk '{OFS="\t"; if($6=="+" && $3 > 14) print $1,$3-15,$3+15,$4,$5,$6; else if($6=="-" && $2>14) print $1,$2-15,$2+15,$4,$5,$6
}' "$i" > "$i".3p.bed; 
done


for i in *3p.bed; do bedToBam -i "$i" -g /campusdata/anjowall/genomes/STAR_genome_hg19/chrNameLength.txt > "$i".bam; 
done
